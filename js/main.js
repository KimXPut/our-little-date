...
document.getElementById('openEnvelope').addEventListener('click',()=>{document.getElementById('openEnvelope').classList.add('hidden');document.getElementById('invitation').classList.remove('hidden')});
